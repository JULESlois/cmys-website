...
export const ANCHOR_EVENTS: AnchorEvent[] = [
  ...
  },
  {
    ...
    choices: [
      { text: "专心学棋", effects: { attributes: { intelligence: 2, creativity: 2, physique: -1} } , resultText: "我把全部精力都放在课本和习题上，两耳不闻窗外事。成绩一路飙升，我成了老师口中的“别人家的孩子”。只是某天我抬头环顾教室，发现同学们讨论的话题，我一句都插不上。"},
  ...
  },
  {
    ...
    choices: [
      { text: "全力抗洪救灾", effects: { attributes: { physique: 3, luck: 2, wealth: -1} } , resultText: "我没有回头。不是不想，是不敢——我怕一回头就再也走不动了。后来母亲在电话里说，她在站台上一直站到火车看不见。我挂掉电话，去图书馆待到闭馆。只有把所有的力气都用在学习上，才能不去想那个越来越远的背影。"},
  ...
  },
  {
    ...
    choices: [
      ...
      { text: "开始思考人生的意义", effects: { attributes: { creativity: 3, luck: 2, physique: -1} } , resultText: "你闭上眼，这一生的画面如走马灯般闪过。那些欢笑、泪水、遗憾和骄傲，都在这一刻化作了嘴角的一抹微笑。夕阳很暖。"},
    ],
  },
  {
  ...
  // ── 青年期 ──
  {
    ...
    choices: [
      ...
      { text: "躺在沙滩上看星星就好", effects: { attributes: { creativity: 3, luck: 2, wealth: -1} }, resultText: "我仰躺在温热的沙滩上，夜空像一口倒扣的锅盖满了芝麻。朋友们陆续睡了，我一个人醒着听海浪。那个晚上我用手机备忘录写了一首诗——很幼稚，但很真实。活着真好。" },
    ],
  },
  ...
  // ── 壮年期 ──
  {
    ...
    choices: [
      ...
      { text: "堵住门缝，在窗口等待救援", effects: { attributes: { intelligence: 2, physique: 1, luck: 2, creativity: -1} }, resultText: "我用湿毛巾堵住门缝，打开所有窗户。在窗台上挥手的时候消防车的云梯过来了。获救后在避难所喝了三杯热茶，手还在抖。但学会了火灾第一课：不要往浓烟里跑。" },
    ],
  },
  ...
  // ── 晚年期 ──
  {
    ...
    choices: [
      ...
      { text: "给儿子打电话，裹着被子等", effects: { attributes: { intelligence: 2, luck: 2, wealth: -1} }, resultText: "我拨了儿子的电话：'别来——路太滑。我裹了被子，没事。'挂掉电话我把所有能穿的都穿上，缩在被子里。天亮的时候暖气修好了。儿子过来看我，嘴唇紧紧抿着——他怕失去我。我更怕让他失去。" },
    ],
  },
