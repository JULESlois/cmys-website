...
export const ANCHOR_EVENTS: AnchorEvent[] = [
  ...
  },
  {
    ...
    choices: [{ text: "（自动）", effects: { attributes: { intelligence: 1, creativity: 1 } } , resultText: "我沉浸在黑白世界里，琢磨着每一步的玄机。老师说我有天赋，我心里偷偷高兴。我渐渐明白，棋盘上的每一颗子都有自己的脾气，而我在学会跟它们相处。"}],
  },
  {
    ...
    choices: [{ text: "（自动）", effects: { attributes: { luck: 1, appearance: 1 } } , resultText: "我敷衍地落下几颗子，心思早飞到窗外去了。围棋对我来说不过是另一种游戏——会下就行，何必认真。老师叹了口气，没再说什么。"}],
  },
  {
  ...
  },
  {
    ...
    choices: [{ text: "（自动）", effects: { attributes: { intelligence: 1, creativity: 2 } } , resultText: "我咬咬牙跳进齐腰深的水里，帮着邻居搬运沙袋和物资。浑浊的洪水冰冷刺骨，我咬着牙一趟又一趟地往返。后来听说那次抗洪救了不少物资，我也因此受到了表扬。"}],
  },
  ...
  // ── 少年期 6-17 ──
  {
    ...
    choices: [
      { text: "认真答题", effects: { attributes: { intelligence: 1, physique: -1} } , resultText: "我安顿好自己，躲在高处的安全地带。看着楼下奔涌的洪水，我暗暗庆幸还好自己没事。虽然没有人责怪我，但我心里某个角落，总觉得有些说不上来的愧疚。"},
  ...
  },
  {
    ...
    choices: [
      { text: "专心学棋", effects: { attributes: { intelligence: 1, creativity: 2, physique: -1} } , resultText: "我把全部精力都放在课本和习题上，两耳不闻窗外事。成绩一路飙升，我成了老师口中的“别人家的孩子”。只是某天我抬头环顾教室，发现同学们讨论的话题，我一句都插不上。"},
      { text: "只想随便玩玩", effects: { attributes: { intelligence: 1, physique: -1} } , resultText: "那两天我几乎没怎么合眼，笔芯用掉了三根。交卷的那一刻，手抖得几乎握不住笔。但我把十二年所学的一切都倾泻在了答卷上——无论结果如何，我无愧于心。"},
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      { text: "全力抗洪救灾", effects: { attributes: { physique: 3, luck: 1, wealth: -1} } , resultText: "我没有回头。不是不想，是不敢——我怕一回头就再也走不动了。后来母亲在电话里说，她在站台上一直站到火车看不见。我挂掉电话，去图书馆待到闭馆。只有把所有的力气都用在学习上，才能不去想那个越来越远的背影。"},
      { text: "保自己安全为先", effects: { attributes: { physique: 1, creativity: -1} } , resultText: "我走到她面前，心脏快要从嗓子眼跳出来。我说'我喜欢你'，声音小得连自己都听不清。她愣了一下，然后笑了。那个笑容比图书馆窗边的阳光还要明亮——无论答案是什么，这一刻我都会记一辈子。"},
    ],
  },
  {
    ...
    choices: [
      ...
      { text: "专注自己学业", effects: { attributes: { intelligence: 1, physique: -1} } , resultText: "我脱下学士服，换上正装，挤进早高峰的地铁。办公室的格子间比宿舍的书桌还小，但我觉得自己像一头准备冲撞世界的公牛。第一份工作的工牌挂在胸前，沉甸甸的——那是名为'大人'的入场券。"},
    ],
  },
  ...
  // ── 青年期 18-30 ──
  {
    ...
    choices: [
      { text: "全力以赴", effects: { attributes: { intelligence: 3, luck: 1, physique: -1} } , resultText: "当同学们忙着投简历时，我回到图书馆的老位置坐下。窗外还是那棵银杏树，只是叶子又黄了一次。我知道自己在逃避什么——但也知道自己在追寻什么。读书是一场漫长的修行，而我还不想下山。"},
      { text: "心态平和，尽力就好", effects: { attributes: { intelligence: 1, creativity: 2, physique: -1} } , resultText: "你开始习惯在凌晨醒来，脑子里排满一整天的日程。房贷、父母的体检费、孩子的辅导班——这些数字压在你肩上，却也让你感到前所未有的踏实。原来被需要，也是一种力量。"},
    ],
  },
  {
    ...
    choices: [
      { text: "拥抱母亲，承诺常回家", effects: { attributes: { creativity: 2, luck: 1, wealth: -1} } , resultText: "你婉拒了那个升职的机会，推掉了几个应酬。朋友们都说你疯了，但你心里清楚——有些风景，过了这个年纪就再也看不到了。你背着包去了年轻时想去的地方，在异乡的街头，给家里打了一个长长的电话。"},
      { text: "头也不回地走", effects: { attributes: { intelligence: 1, wealth: -1 } } , resultText: "你带着团队拿下了那个最难啃的项目。庆功宴上大家轮流敬酒，你笑着喝了一杯又一杯，胃里翻江倒海，面上不动声色。散场后你一个人坐在车里，揉了揉太阳穴——高处不胜寒，但你还没打算下来。"},
    ],
  },
  {
    ...
    choices: [
      { text: "鼓起勇气表白", effects: { attributes: { appearance: 2, luck: 1, wealth: -1} } , resultText: "你推掉了几个可有可无的会议，一个人在美术馆里待了一下午。站在那幅巨大的油画前，你突然意识到，这些年你一直在赶路，却忘了问自己要去哪里。手机亮了一下，你没有接。"},
  ...
  },
  {
    ...
    choices: [
      { text: "投身职场，大干一场", effects: { attributes: { wealth: 3, intelligence: 1, physique: -1} } , resultText: "你抵押了房子，投进一个外人看不懂的方向。妻子沉默了一整晚，第二天早上给你下了碗面。你吃着面，眼泪差点掉进碗里——你知道，这一局，不只是为了赢。"},
      { text: "继续深造，充实自己", effects: { attributes: { intelligence: 1, creativity: 1, physique: -1} } , resultText: "你在退休申请上签了字，放下笔的那一刻，手有些抖。整理办公桌时翻出二十年前的名片，上面的自己意气风发。你把名片夹进笔记本，轻轻合上——这一页，翻过去了。"},
    ],
  },
  ...
  // ── 壮年期 31-60 ──
  {
    ...
    choices: [
      { text: "扛起责任，一往无前", effects: { attributes: { physique: 2, wealth: 2, intelligence: 1, luck: -1} } , resultText: "你拒绝了公司的退休方案，转身接了一个谁都不看好的咨询项目。老部下劝你歇歇，你说：'歇？我这一辈子就没学会怎么歇。'屏幕的光映在你花白的头发上，你的眼睛却比年轻人还亮。"},
  ...
  },
  {
    ...
    choices: [
      ...
      { text: "开始思考人生的意义", effects: { attributes: { creativity: 2, luck: 1, physique: -1} } , resultText: "你闭上眼，这一生的画面如走马灯般闪过。那些欢笑、泪水、遗憾和骄傲，都在这一刻化作了嘴角的一抹微笑。夕阳很暖。"},
    ],
  },
  {
    ...
    choices: [
      { text: "求稳，守住已有一切", effects: { attributes: { wealth: 3, physique: -1, luck: 1 } } , resultText: "你想起了那本只写了一半的书、那个搁置多年的计划。心中涌起一股不甘——但随即又平静下来。有遗憾，才是真实的人生。"},
      { text: "大胆落子，再搏一局", effects: { attributes: { creativity: 2, wealth: -2, luck: -1 } } , resultText: "你抱着孙儿，从童年的萤火虫讲起，一直讲到鬓角的白发。小家伙睁大了眼睛，在你怀里安静下来。你忽然明白——生命就是这样，一代又一代，故事连着故事。"},
    ],
  },
  {
    ...
    choices: [
      { text: "功成身退，颐养天年", effects: { attributes: { luck: 1, physique: 2, intelligence: -1} } , resultText: "你看着孙儿在玩具堆中笑闹，心里却泛起一丝复杂。物质的丰裕固然重要，但你更希望他长大后能记得这个午后——记得爷爷看他的眼神。你的手轻轻抚过他的头。"},
      { text: "老当益壮，再干一场", effects: { attributes: { wealth: 3, intelligence: 1, physique: -1 } } , resultText: "你落下一子，不紧不慢。对面的老友笑了，说你还是当年的你。你也笑了。棋至终局，胜负早已不重要——能坐到一起，就已经赢了。"},
    ],
  },
  {
